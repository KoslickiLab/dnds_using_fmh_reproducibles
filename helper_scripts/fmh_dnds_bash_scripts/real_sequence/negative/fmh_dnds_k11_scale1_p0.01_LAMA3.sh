...
#Parameters
wd=/data/jzr5814/sourmash_dnds_estimation/tests/test/real_sequence_selection_mutation_0.01/negative/fmh_k11
k='11'
scaled=1
...
#using sngl mode
dna_filename=${wd}/../negative_selection_queries_0.01_K06240.fna
protein_filename=${wd}/../negative_selection_translated_queries_0.01_K06240.faa

#outname
out=K06240_negative_0.01
